...
return [
    ...
    */
    ...
    'use_route_url' => false,
    'dashboard_url' => 'home',
    'logout_url' => false, // Disable default logout URL, we'll use custom menu item
    'login_url' => 'login',
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'Approved',
                    'url' => 'admin/submissions?status=approved',
                    'icon' => 'fas fa-fw fa-check',
                ],
                [
                    'text' => 'Rejected',
                    'url' => 'admin/submissions?status=rejected',
